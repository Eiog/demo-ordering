...
<template>
  <view
    class="w-full h-full flex items-center gap-3 px-3 bg-white shadow shadow-md shadow-gray-200 rounded-xl"
  >
    ...
    >
      <text class="text-white text-xs" @click="handleLogin">授权登录</text>
    </view>
  </view>
</template>
